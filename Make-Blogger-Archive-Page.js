...
function DisplaytheTOC(PostTitles,PostURLs,PostYears,PostMonths,PostDays)
{
	...
	if (true) {
	  document.getElementById("seventeen").innerHTML += ('<a href ="' + PostURLs[EntryNum] + '">' + PostTitles[EntryNum] + "</a> (" + parseInt(PostDays[EntryNum],10) + " " + NameOfMonth + " " + PostYears[EntryNum] + ")<br />");
